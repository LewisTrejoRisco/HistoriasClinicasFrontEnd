...
import { ReporteAtencionMedica } from "../utilitarios/reporteAtencionMedica.model";
...
export class SolicitarService {
    ...
    generateReporAtenMeditWithAdapter(headers: string[], data: ReporteAtencionMedica[], filename: string) {
      const workbook = new ExcelJS.Workbook();
      const worksheet = workbook.addWorksheet("Hoja 1");
      ...
      const headerToPropertyMap = {
        ...
        'Edad':'tedad',  
        'Apellido Paterno':'tapelpate',
        'Apellido Materno':'tapelmate',  
        'Nombres':'tnombpila',  
        'Área':'tdescunidfunc',  
        'Diagnóstico':'tdiagnostico'
    }
